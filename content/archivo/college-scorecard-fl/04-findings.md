...
SELECT
    ...
    printf('%,d', CAST(ROUND(avg_net_price, 0) AS INTEGER))                                             AS "Avg Net Price",
    ROUND(avg_completion * 100, 1)                                                                      AS "Avg Completion %",
    printf('%,d', CAST(ROUND(avg_net_price / NULLIF(avg_completion, 0), 0) AS INTEGER))                 AS "Cost / Completer",
...
SELECT
    ...
    printf('%,d', SUM(am.ugds))                                                                 AS "Total UG Enrollment",
...
SELECT
    ...
    printf('%,d', SUM(am.ugds))                               AS "Total Enrollment",
    printf('%,d', CAST(ROUND(AVG(am.ugds), 0) AS INTEGER))    AS "Avg Enrollment"
FROM annual_metrics am
...
SELECT
    instnm                                      AS "Institution",
    sector_display                              AS "Sector",
    printf('%,d', md_earn_wne_p10)              AS "10-Year Earnings",
