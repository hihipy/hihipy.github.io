...
SELECT
    ...
    printf('%,d', COUNT(*))                  AS "Total Rows",
    printf('%,d', COUNT(ugds))               AS "Non-Null",
...
SELECT
    ...
    printf('%,d', COUNT(*)),
    printf('%,d', COUNT(md_earn_wne_p10)),
...
SELECT
    ...
    END                                                    AS "Sector",
    printf('%,d', COUNT(*))                                AS "Rows",
    printf('%,d', COUNT(am.md_earn_wne_p10))               AS "Earnings Filled",
